...
RUN apt-get install --no-install-recommends -y gunicorn3 wget git libmagic-dev gcc binutils libproj-dev gdal-bin python3 python3-setuptools python3-dev python3-pip tzdata cron rsyslog apache2
